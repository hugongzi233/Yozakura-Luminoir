...
@locate x=90 y=100
@button graphic="select" single=true text="我想继续跟你一起走下去" color=0xffffff size=26 offset=77 target="*win"

@locate x=90 y=210
@button graphic="select" single=true text="对不起，我拒绝" color=0xffffff size=26 offset=40 target="*lose"
@s
